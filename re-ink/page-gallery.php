    ...
    <div class="container">
        <div class="page-hero-inner">
            <div class="fi">
                ...
                <span class="page-hero-ja">【 作品ギャラリー 】</span>
            </div>
        </div>
    </div>
</section>
...
<section class="gallery-sec">
    <div class="container">
        ...
        <div class="gallery-load-more fi">
            <button class="btn btn-ghost" id="load-more" data-current-page="1"
                data-max-pages="<?php echo esc_attr( $works_query->max_num_pages ); ?>"
                <?php echo $works_query->max_num_pages <= 1 ? 'hidden' : ''; ?>>Load More Works</button>
        </div>
    </div>
</section>
